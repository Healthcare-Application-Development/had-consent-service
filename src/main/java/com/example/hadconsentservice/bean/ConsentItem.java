...
public class ConsentItem {
    ...
    public ConsentItem(Integer id, String doctorID, String patientID, String consentMessage, Boolean consentAcknowledged, Boolean approved, Date fromDate, Date toDate, ConsentArtifact consentArtifact, Boolean ongoing) {
        this.id = id;
